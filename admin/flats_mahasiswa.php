...
if ($_GET['aksi'] == '') {
?>
    <h4 style='padding-top:15px'>Product Krisis</h4>
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <a class='btn btn-warning' href='utils/allow_all.php'><i class='fa fa-file'></i> Open</a>
                <a class='btn btn-success' href='utils/allow_p.php'><i class='fa fa-file'></i> Pinjaman</a>
                <a class='btn btn-success' href='utils/allow_b.php'><i class='fa fa-file'></i> B. Penghidupan</a>
                <a class='btn btn-danger' href='utils/deny_all.php'><i class='fa fa-file'></i> Close</a>
            </div>
            ...
            <div class="panel-body">
                <table class="table table-striped table-bordered table-hover dataTables-example">
                    ...
                    <tbody>
                        <?php
                        $mahasiswa = mysqli_query($conn, "SELECT mahasiswa.username_mhs, mahasiswa.status, mahasiswa.nif, mahasiswa.nama_mhs, mahasiswa.angkatan, kampus.nama_kampus, gembala.nama_gembala 
...
<?php
    ...
    if (isset($_POST['simpan'])) {
        ...
        if ($ceknif > 0) {
            ...
            mysqli_query($conn, "INSERT INTO `mahasiswa` (`nif`, `nama_mhs`, `angkatan`, `kampus`, `username_mhs`, `password_mhs`, `gembala_mhs`, `repo_mhs`, `ukt`, `jalur`, `status`) VALUES 
                    ('$_POST[nif]', 
                    '$_POST[nama_lengkap]', 
                    '$_POST[angkatan]', 
                    '$_POST[kampus]', 
            ...
            <div class="panel-body">
                <form action='' class="form-horizontal" method="POST" data-validate="parsley" enctype='multipart/form-data'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="number" name="ukt" placeholder="" class="bg-focus form-control" data-required="true">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">Izin Pengajuan</label>
                        <div class="col-lg-4">

                            <select name='status' class="form-control" required>
                                <option value='0'><?= statusMhs(0) ?></option>
                                <option value='1'><?= statusMhs(1) ?></option>
                                <option value='10'><?= statusMhs(10) ?></option>
                                <option value='11'><?= statusMhs(11) ?></option>
                                <option value='12'><?= statusMhs(12) ?></option>
                                <option value='13'><?= statusMhs(13) ?></option>
                            </select>
                        </div>
                    </div>
                ...
                <form action='' class="form-horizontal" method="POST" data-validate="parsley" enctype='multipart/form-data'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            ...
                            <select name='status' class="form-control" required>
                                <option value="<?= $e['status'] ?>"><?= statusMhs($e['status']) ?></option>
                                <option value='0'><?= statusMhs(0) ?></option>
                                <option value='1'><?= statusMhs(1) ?></option>
                                <option value='10'><?= statusMhs(10) ?></option>
                                <option value='11'><?= statusMhs(11) ?></option>
